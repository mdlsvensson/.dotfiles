...
browser = "firefox"
browser_profile = "mdlsvensson"
browser_cmd = browser .. " -p " .. browser_profile
rofi_cmd = "rofi -show"
bookmarks = "rofi-buku"
...
globalkeys = gears.table.join(
    ...
    -- launcher
    awful.key({ modkey, }, "d", function() awful.util.spawn(rofi_cmd) end,
    ...
    awful.key({ modkey, }, "f", function() awful.spawn(file_manager) end,
        { description = "open a new file manager window", group = "launcher" }),
    awful.key({ modkey, }, "w", function() awful.spawn(browser_cmd) end,
        { description = "open a new browser window", group = "launcher" }),
    awful.key({ modkey, }, "b", function() awful.util.spawn(bookmarks) end,
